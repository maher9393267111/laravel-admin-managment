    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <div class="col-md-12">
                ...
                <h5 class="m-b-15">Create Leave <span class="float-right f-13 text-muted"><a href="{{route('leaves.index')}}" class="btn btn-sm btn-primary">Back</a></span></h5>
                <hr>
                <form action="{{route('leaves.store')}}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control  @error('start_date') is-invalid @enderror" name="start_date" id="start_date" placeholder="Leave Start Date">
                            @error('start_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control  @error('end_date') is-invalid @enderror" name="end_date" id="end_date" placeholder="Leave End Date">
                            @error('end_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control  @error('end_date') is-invalid @enderror" id="reason" rows="10" cols="30" name="reason"></textarea>
                            @error('reason')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
