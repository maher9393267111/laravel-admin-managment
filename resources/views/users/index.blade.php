                ...
                <div class="card">
                    <div class="card-header">
                        <span class="d-block m-t-4">
                            ...
                            <a href="{{route('user.create')}}" class="btn btn-primary btn-sm">Add Staff</a>
                        </span>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('delete-users')
                                                <a onclick="handleDelete({{ $user->id }})" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalLive" style="color: white">Delete</a>
                                            @endcan
